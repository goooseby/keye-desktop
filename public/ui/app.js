...
function renderAbout(){
  main.innerHTML=`<section class="about-hero"><div class="about-mark"><img src="/app-icon.svg" alt="课页图标"></div><div class="about-intro"><div class="eyebrow">ABOUT KEYE</div><h1>课页 <span>KEYE</span></h1><p>把课堂课件的获取、筛选和 PDF 导出，整理成一条清楚、安静的工作流。</p><div class="about-actions"><span class="about-version">当前版本 v${esc(state.appVersion||'0.2.0')}</span><button class="secondary" data-action="show-help">${icon('help')}查看使用说明</button></div></div><div class="about-decoration" aria-hidden="true"><i></i><i></i><i></i></div></section>
    ...
    <section class="panel about-uninstall"><div><div class="eyebrow">INSTALLATION</div><h2>安装与卸载</h2><p>卸载向导可选择保留或删除默认应用数据。单独选定的资料库目录及已导出的 PDF 不会随程序卸载。</p></div><button class="secondary" data-action="uninstall" ${state.packaged?'':'disabled'}>打开卸载向导</button></section>
    <section class="panel about-details"><div><div class="eyebrow">PROJECT INFORMATION</div><h2>项目信息</h2></div><dl><div><dt>应用名称</dt><dd>课页 · Keye</dd></div><div><dt>当前版本</dt><dd>v${esc(state.appVersion||'0.2.0')}</dd></div><div><dt>适用系统</dt><dd>Windows 10 / 11</dd></div><div><dt>项目主页</dt><dd>github.com/goooseby/keye-desktop</dd></div></dl><p class="about-note">课页是一个开源的个人课件整理工具。账号凭据仅在当前运行中使用，不会写入课件数据库。</p></section>`;
  renderUpdateStatus();
}
